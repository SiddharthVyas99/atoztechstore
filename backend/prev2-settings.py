...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'atoztechstore.herokuapp.com']
...
STATIC_TMP2 = os.path.join(BASE_DIR, 'frontend/build/static')
STATIC_URL = '/static/'
MEDIA_URL = '/images/'

os.makedirs(STATIC_TMP, exist_ok=True)
os.makedirs(STATIC_TMP2, exist_ok=True)
